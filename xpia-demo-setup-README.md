...
| 5 | Sends test XPIA emails (3 payload variants) | §3.1, Appendix B |
...
4. **KQL queries** — Phase 6 outputs them; paste and save in Advanced Hunting manually
5. **Browser tabs** — Phase 8 reminds you which tabs to pre-stage
...
| Test emails fail to send | `Send-MailMessage` needs SMTP relay access. Send manually from OWA instead |
